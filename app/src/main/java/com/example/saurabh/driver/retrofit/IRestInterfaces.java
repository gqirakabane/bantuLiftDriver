...
import com.example.saurabh.driver.modelclass.CreatepullModelclass.CreatePullModelclass;
import com.example.saurabh.driver.modelclass.GetCarTypeModel.CarTypeModelclass;
...
public interface IRestInterfaces {
 ...
 @FormUrlEncoded
    ...
    Call<RequestPollModel> getRequestedPolls(@Field("serviceKey") String serviceKey,
                                             @Field("userId") String userId);@FormUrlEncoded
